...
device = input(f"Введи имя устройства ({', '.join(london_co.keys())}) : ") ; device_param = london_co.get(device) ; parameter = input(f"Введи параметр устройства ({', '.join(london_co.get(device).keys())}) : ") ; print(device_param.get(parameter, "Такого параметра нет"))
